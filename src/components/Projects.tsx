...
const Projects = ({ isPrintView = false }: ProjectsProps) => {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {markdownResumeData.projects.map((project, index) => {
            ...
            if (isPrintView) {
              return (
                <div key={project.name} className="bg-white rounded-xl shadow-lg overflow-hidden border border-secondary-100">
                  {projectContent}
                </div>
              );
            }
