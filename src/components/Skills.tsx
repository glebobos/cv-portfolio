...
const Skills = ({ isPrintView = false }: SkillsProps) => {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid gap-8">
          {markdownResumeData.skillCategories.map((category, categoryIndex) => {
            ...
            if (isPrintView) {
              return (
                <div key={category.name} className="bg-secondary-50 rounded-2xl p-6 border border-secondary-100">
                  {categoryContent}
                </div>
              );
            }
              ...
              {[
                {
                  ...
                  value: markdownResumeData.skillCategories.reduce((count, cat) =>
